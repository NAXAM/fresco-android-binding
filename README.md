<img src="./art/repo_header.png" alt="Fresco for Xamarin.Android" width="728" />

# Fresco for Xamarin.Android
A Xamarin.Android binding library for [Fresco](http://frescolib.org) library.
...
```
Install-Package Naxam.Fresco.Droid
```

## Usage

Plz follow its official guide [here](http://frescolib.org/docs/index.html).

## License

Fresco binding library for Android is released under the MIT license.
...
Follow us for the latest updates<br>[![Twitter URL](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=https://github.com/naxam/fresco-android-binding)
